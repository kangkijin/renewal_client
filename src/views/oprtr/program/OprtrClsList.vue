          ...
          <div class="left wd_p100">
            <div class="radio_tab_lg_wrap">
              <p class="radio_tab_lg">
                <input type="radio" name="radio_tab_lg" id="radio1_1" class="hidden" value="" checked />
            ...
            <div class="myclass_wrap">
              <div class="myclass_header">
                <div class="quick_move">
                  <router-link to="" class="btn_icon icon_only arrow_prev_white">이전탭</router-link>
                  <p class="tab_title">강의실</p>
                  <router-link to="/program/programOprt/test" class="btn_icon icon_only arrow_next_white"
                    >다음탭</router-link
                  >
                </div>
                <div class="count">
                ...
                <div class="list_btn">
                  <router-link to="/program/programOprt/class/regist" class="btn_icon myprogram">강의등록</router-link>
                </div>
              </div>
                ...
                <div class="myclass_listwrap operator">
                  <ul class="lesson_list">
                    <li>
                      ...
                      <div class="link">
                        <router-link to="/program/programOprt/class/detail" class="btn_playlesson">
                          <div class="img_wrap">
                    ...
                    <li>
                      <div class="schedule">
                        ...
                        <!-- 수업 종류에 따른 라벨
                          ...
                          오프라인 : navy
                        -->
                        <span class="lesson_label blue">ZOOM</span>
                      </div>
                      <div class="name">
                        <div class="name_wrap">
                          <div>
                    ...
                    <li>
                      <div class="schedule">
                        ...
                        <!-- 수업 종류에 따른 라벨
                          ...
                          오프라인 : navy
                        -->
                        <span class="lesson_label red">유튜브</span>
                      </div>
                      <div class="name">
                        <div class="name_wrap">
                          <div>
                      ...
                      <div class="link">
                        <router-link to="" class="btn_playlesson">
                          <div class="img_wrap">
                            <img src="@/assets/images/program/img_program_thumbnail.png" alt="비교과 이미지" />
                          </div>
                          <p class="progressbar">
                            <span class="wd_p30"></span>
                          </p>
                        </router-link>
                      </div>
                    </li>
                    ...
                    <li>
                      <div class="schedule">
                        ...
                        <!-- 수업 종류에 따른 라벨
                          ...
                          오프라인 : navy
                        -->
                        <span class="lesson_label navy">오프라인</span>
                      </div>
                      <div class="name">
                        <div class="name_wrap">
                          <div>
