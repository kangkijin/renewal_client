<template>
  <div class="search_box">
    <div class="search_section">
      <div class="search_toggle lg center flip">
        <div class="left">
          <p class="total_count"><strong>5</strong>개의 설문조사</p>
        </div>
        <div class="right">
          ...
          <div class="search_row">
            <input type="search" class="form_style wd_p100" placeholder="설문조사를 찾아보세요" />
  ...
  <div class="program_doublewrap other">
    <div class="program_viewbox">
      <button type="button" class="texter" @click="popupShow(0)">이어서<br />참여하기</button>
      <div class="cnt">
        <p class="title">대학수요만족도 조사[학생]</p>
        <div class="labels">
          <span>설문조사1</span>
          <span>설문조사2</span>
          <span>설문조사3</span>
        ...
        <ul class="function">
          <li class="icon calendar"><strong>조사기간</strong>24/01/05 09:30~24/01/15 18:30</li>
          <li class="icon person"><strong>조사지 수</strong>5개</li>
        </ul>
      </div>
    </div>
    <div class="program_viewbox">
      <button type="button" class="texter">설문<br />참여</button>
      <div class="cnt">
        <p class="title">대학수요만족도 조사[학생] 대학수요만족도 조사[학생] 대학수요만족도 조사[학생]</p>
        <div class="labels">
          <span>설문조사1</span>
          <span>설문조사2</span>
          <span>설문조사3</span>
    ...
    <div class="program_viewbox">
      ...
      <div class="cnt">
        ...
        <button type="button" class="view" @click="popupShow(1)">제출내역보기</button>
      </div>
    </div>
    <div class="program_viewbox">
      <!-- 기간 종료시 클래스 close 추가 -->
      ...
      <div class="cnt">
        ...
        <button type="button" class="view">제출내역보기</button>
      </div>
    </div>
    <div class="program_viewbox">
      <button type="button" class="texter" disabled>참여<br />완료</button>
  ...
  <PopupView v-model="isPopups[0]" class="xlarge">
    <template #title>설문조사 참여</template>
    <div class="diag_desc">
      <div class="top">
        <div><strong>조사명</strong>(설문조사명)</div>
      ...
      <div class="diag_timer_wrap">
        <div class="diag_timer">
          ...
          <div class="btn_area">
            ...
            <button type="button" class="btn_round btn_lg btn_secondary">조사 제출하기</button>
          </div>
        </div>
      </div>
  ...
  <PopupView v-model="isPopups[1]" class="xlarge">
    <template #title>설문조사 제출내역</template>
    <template #footer>
    ...
    <div class="dp_flex al_center jc_end mb-4">
      <span class="bold mr-4">조사지 선택</span>
...
export default {
  ...
  data: () => ({
    selectOption: {
      ...
      options: [{ label: "이어서 참여하기" }, { label: "설문참여" }, { label: "참여완료" }, { label: "기간종료" }],
    },
    selectOption2: {
      value: "(조사지 1명)",
      options: [{ label: "(조사지 1명)" }, { label: "(조사지 2명)" }],
    },
