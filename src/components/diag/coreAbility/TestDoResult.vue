<template>
  <div class="flex_wrap diag_testwrap">
      ...
      <div class="box test_start">
        ...
        <div class="test_stare">
          <p class="title">
            ...
            2024학년도 핵심역량진단 2024학년도 핵심역량진단 2024학년도 핵심역량진단 2024학년도 핵심역량진단
          </p>
    ...
    <div>
      ...
      <div class="box test_result">
        ...
        <ul class="testresult_list">
          <li>
            <div>
              <p class="title">2024학년도 핵심역량진단 (1차)<span class="label">미응시</span></p>
              <div class="function">
          ...
          <li>
            <div>
              <p class="title">2024학년도 핵심역량진단 (1차)</p>
              <div class="function">
    ...
    <div>
      <div class="section_tit_wrap">
        <h4 class="section_tit2">핵심역량진단 비교그래프</h4>
      </div>
