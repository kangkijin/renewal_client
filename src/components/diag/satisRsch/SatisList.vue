<template>
  <div class="search_box">
    <div class="search_section">
      <div class="search_toggle lg center flip">
        <div class="left">
          <p class="total_count"><strong>5</strong>개의 만족도조사</p>
        </div>
        <div class="right">
          ...
          <div class="search_row">
            <input type="search" class="form_style wd_p100" placeholder="만족도조사를 찾아보세요" />
  ...
  <div class="program_doublewrap other">
    ...
    <div class="program_viewbox">
      <button type="button" class="texter">조사<br />참여</button>
      <div class="cnt">
  ...
  <PopupView v-model="isPopups[0]" class="xlarge">
    <template #title>만족도조사 참여</template>
    <div class="diag_desc">
      <div class="top">
        <div><strong>조사명</strong>(만족도조사명)</div>
