<template>
  <div class="flex_wrap diag_testwrap">
    <div>
      <div class="section_tit_wrap">
        <h4 class="section_tit2">전공능력진단응시</h4>
      </div>
    ...
    <div>
      <div class="section_tit_wrap">
        <h4 class="section_tit2">전공능력진단 결과</h4>
      </div>
      <div class="box test_result">
        ...
        <ul class="testresult_list">
          <li>
            <div>
              <p class="title">2024학년도 전공능력진단 (1차)<span class="label">미응시</span></p>
              <div class="function">
    ...
    <div>
      <div class="section_tit_wrap">
        <h4 class="section_tit2">전공능력진단 비교그래프</h4>
      </div>
      <div class="box graph_box">
        <!-- 결과 없을 경우 표출 -->
        <!--  
          <div class="test_before">
            <div>
  ...
  <PopupView v-model="isPopups[0]" class="xlarge">
    <template #title>전공능력진단 응시</template>
    <div class="diag_desc">
      <div class="top">
        <div><strong>진단명</strong>(전공능력진단실시계획명)</div>
  ...
  <PopupView v-model="isPopups[1]" class="xlarge">
    <template #title>전공능력진단 결과</template>
    <template #footer>
    ...
    <div class="sm_section">
      <div class="toggle_wrap diag_toggle">
        <div class="left">
          <h5 class="section_tit_sm">강점역량·약점역량·중간역량</h5>
        </div>
        <div class="right">
          <span class="bold">전공능력진단 선택</span>
          <vue-select class="select_box wd_220" :options="selectedOption.groups" :placeholder="'선택'"></vue-select>
